					...
					<nav style="text-align: center;">
						<ul class="pagination">
							<c:choose>
								...
								<c:otherwise>
									<li>
										<a href="${pageContext.servletContext.contextPath }/lprod/lprodPagingList" aria-label="Previous">
							...
							<c:forEach begin="1" end="${lastPage }" var="i">
								...
								<li class="${active }">
									<a href="${pageContext.servletContext.contextPath }/lprod/lprodPagingList?page=${i }">${i }</a>
								</li>
							...
							<c:choose>
								...
								<c:otherwise>
									<li>
										<a href="${pageContext.servletContext.contextPath }/lprod/lprodPagingList?page=${lastPage}"
											aria-label="Next">
											<span aria-hidden="true">&raquo;</span>
										</a>
									</li>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$(".lprodTr").on("click", function() {
				...
				// /user
				// 1. docuemnt
				document.location = "/prod/prodList?lgu=" + lgu;
